...
document.querySelectorAll(".image-slider").forEach((slider) => {
  ...
  let attractionGuideArray = [
    ...
    {
          image: "images/amalaSpot.jpg",
          guideName: "Amala Spot",
          guideAddress: "Amala Spot is located at 5, NTA-Ilawe Bypass (after the Federal Polytechnic Ado-Ekiti satellite campus) ",
          guideDescription:" Amala Spot in Ado Ekiti is a popular local eatery known for serving some of the best traditional Nigerian dishes, with a special focus on Amala – a beloved Yoruba delicacy made from yam flour. The restaurant offers a cozy, no-frills environment where guests can enjoy delicious, home-cooked meals in a relaxed setting. At Amala Spot, the star attraction is, of course, the Amala served with a variety of rich and flavorful soups, such as Efo Riro, Gbegiri, and Ogbono, along with tender meats like Goat meat, Beef, and Assorted meats."
        }, 
